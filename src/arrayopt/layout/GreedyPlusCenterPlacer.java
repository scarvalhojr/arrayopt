 ...
 */
public class GreedyPlusCenterPlacer implements LayoutAlgorithm, FillingAlgorithm
{	
	/**
	 ...
	 */
	public GreedyPlusCenterPlacer (int mode, int window_size, int kvalue)
	{
		switch (mode)
		{
		...
		this.ordering = new SortedSequencesOrdering(SortedSequencesOrdering.CENTERED);
	}
